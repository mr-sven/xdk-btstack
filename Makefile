...
export BCDS_APP_NAME = XDK-BTstack
...
export BCDS_XDK_INCLUDES = \
    ...
    -I$(BCDS_APP_SOURCE_DIR)/btstack/ \
    -I$(BCDS_APP_SOURCE_DIR)/btstack/src \
    -I$(BCDS_APP_SOURCE_DIR)/btstack/3rd-party/bluedroid/encoder/include \
    -I$(BCDS_APP_SOURCE_DIR)/btstack/3rd-party/bluedroid/decoder/include \
    -I$(BCDS_APP_SOURCE_DIR)/btstack/3rd-party/yxml \
    -I$(BCDS_APP_SOURCE_DIR)/btstack/3rd-party/md5 \
    -I$(BCDS_APP_SOURCE_DIR)/btstack/chipset/em9301
...
export BCDS_XDK_APP_SOURCE_FILES = \
	...
	$(wildcard $(BCDS_APP_SOURCE_DIR)/btstack/src/*.c) \
	$(wildcard $(BCDS_APP_SOURCE_DIR)/btstack/src/ble/*.c) \
	$(wildcard $(BCDS_APP_SOURCE_DIR)/btstack/platform/embedded/*.c) \
	$(wildcard $(BCDS_APP_SOURCE_DIR)/btstack/platform/freertos/*.c) \
	$(wildcard $(BCDS_APP_SOURCE_DIR)/btstack/chipset/em9301/*.c)
